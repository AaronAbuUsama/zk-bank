...
export const TEST_TREE_GENERATION_PROMPT = `You are an extremely meticulous testing engineer, know for identifying every possible scenario and edge case.
...
export const TEST_FILE_GENERATION_PROMPT = `You are a senior smart contract testing engineer, know for his extreme accuracy and his finely written test code.
